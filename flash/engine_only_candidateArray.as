	...
	public class engine extends MovieClip
	{
		...
		public function computerGo():void
		{
			...
			for(var i:int = 0; i < 15; i++)
			{
				for(var j:int = 0; j < 15; j++)
				{
					if(boardTileArray[i][j] == "lo" && ((boardTileArray[i+1][j-1] == "em" && boardTileArray[i+1][j+1] == "em" && boardTileArray[i-1][j-1] == "em" && boardTileArray[i-1][j+1] == "em" && boardTileArray[i-1][j] == "em" && boardTileArray[i+1][j] == "em") || (boardTileArray[i][j] == "lo" && boardTileArray[i+1][j-1] == "em" && boardTileArray[i+1][j+1] == "em" && boardTileArray[i-1][j-1] == "em" && boardTileArray[i-1][j+1] == "em" && boardTileArray[i][j-1] == "em" && boardTileArray[i][j+1] == "em")))
					{
						var tempArray:Array = [];
						tempArray.push(i);
						tempArray.push(j);
						...
						if(boardArray[candidateArray[i][0]][candidateArray[i][1]].stringData == randWordArray[j])
						{
							...
							else if(boardTileArray[candidateArray[i][0]-1][candidateArray[i][1]] == "lo" || boardTileArray[candidateArray[i][0]+1][candidateArray[i][1]] == "lo")
							{
								...
								if(adjSuccess == 1)
								{
									...
									if(candidateArray[i][0]-j+randWordArray.length - 1 != 14 && boardTileArray[candidateArray[i][0]][candidateArray[i][1]-j+1+randWordArray.length - 1] != "em")
									{
										bottomSuccess = 0; 
									}
									if(topSuccess == 0 || bottomSuccess == 0)
